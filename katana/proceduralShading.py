prod = '''<katana release="3.1v5" version="3.1.3.000001">
  <node name="__SAVE_exportedNodes" type="Group">
    <node baseType="NetworkMaterial" name="Hammer_NetworkMaterial" selected="true" type="NetworkMaterial" x="295.000000" y="146.500000">
      <port name="prmanBxdf" source="Hammer_PSN.out" type="in">
        <tags>
          <tag name="bxdf"/>
        </tags>
      </port>
      <port name="out" type="out"/>
      <group_parameter name="Hammer_NetworkMaterial">
        <string_parameter name="name" value="Hammer_NetworkMaterial"/>
    ...
    <node baseType="PrmanShadingNode" name="Hammer_dirt" selected="true" type="PrmanShadingNode" x="301.000000" y="284.500000">
      ...
      <group_parameter name="Hammer_dirt">
        <string_parameter name="name" value="Hammer_dirt"/>
    ...
    <node baseType="PrmanShadingNode" edited="true" name="Hammer_blend" selected="true" type="PrmanShadingNode" x="301.000000" y="240.500000">
      ...
      <port name="topA" source="Hammer_dirt.resultR" type="in">
        <tags>
          <tag name="float"/>
        </tags>
        <metadata>
      ...
      <group_parameter name="Hammer_blend">
        <string_parameter name="name" value="Hammer_blend"/>
    ...
    <node baseType="PrmanShadingNode" name="Hammer_PSN" selected="true" type="PrmanShadingNode" x="295.000000" y="193.500000">
      ...
      <port name="diffuseColor" source="Hammer_blend.resultRGB" type="in">
        <tags>
          <tag name="color"/>
        </tags>
        <metadata>
      ...
      <group_parameter name="Hammer_PSN">
        <string_parameter name="name" value="Hammer_PSN"/>
